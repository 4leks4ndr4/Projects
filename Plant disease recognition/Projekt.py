...
dracena_przelana = "monstera_variegata1.mp4"
cap = cv2.VideoCapture(dracena_przelana)

if not cap.isOpened():
    raise IOError("Nie można otworzyć filmu")
...
while True:
    ...
    cv2.imshow("Wykrywanie obiektu", frame)
